package com.yeumkyuseok.youtubeplayer;
...
public class YoutubeActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    static final String GOOGLE_API_KEY = "AIzaSyBFcWNpjp7CnAK0y1XfLPfUX6mf8qSSHN0";
    static final String YOUTUBE_VIDEO_ID = "hnanNlDbsE4";
    static final String YOUTBE_PLAYLIST = "PLif_jr7pPZACIf_-P3h9zwIa_ygaCPMqO";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*  Example of creating button using java instead of xml
